#!/usr/bin/python3
"""
Prime Game solution - Determining the winner of a game based on prime number removal.
"""
...
def isWinner(x, nums):
    ...
    Returns:
        str or None: Name of the player with most wins, or None if no clear winner
    """
    if not nums or x <= 0:
        return None
